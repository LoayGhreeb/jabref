...
public class SearchQuery {
    ...
    public SearchQuery(String query, EnumSet<SearchFlags> searchFlags) {
        ...
        SearchFieldConstants.searchableBibFields.forEach(field -> boosts.put(field, 4F));
        ...
        MultiFieldQueryParser queryParser = new MultiFieldQueryParser(fieldsToSearchArray, new StandardAnalyzer(), boosts);
